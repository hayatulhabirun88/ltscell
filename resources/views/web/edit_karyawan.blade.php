                    ...
                    <form action="{{ route('karyawan.update', $user->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama" id="nama"
                                value="{{ old('nama', $user->name) }}" placeholder="Masukan nama lengkap" />
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="no_hp" id="no_hp"
                                value="{{ old('no_hp', $user->no_hp) }}" placeholder="Masukan Nomor Handphone" />
                            @error('no_hp')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="email" id="email"
                                value="{{ old('email', $user->email) }}" placeholder="Masukan Email" />
                            @error('email')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
