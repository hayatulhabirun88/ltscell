                    ...
                    <form action="{{ route('shift.update', $shift->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_shift" id="nama_shift"
                                value="{{ old('nama_shift', $shift->nama_shift) }}" placeholder="Masukan Nama Shift" />
                            @error('nama_shift')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control" name="jam_masuk" id="jam_masuk"
                                value="{{ old('jam_masuk', $shift->jam_masuk) }}" placeholder="Masukan Nomor Handphone" />
                            @error('jam_masuk')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control" name="jam_pulang" id="jam_pulang"
                                value="{{ old('jam_pulang', $shift->jam_pulang) }}" placeholder="Masukan Nomor Handphone" />
                            @error('jam_pulang')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
