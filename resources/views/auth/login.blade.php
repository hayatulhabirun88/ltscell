...
<body>
    ...
    <script type="text/javascript" src="{{ asset('/') }}tmp_mobile/javascript/password-addon.js"></script>
    <script type="text/javascript" src="{{ asset('/') }}tmp_mobile/javascript/main.js"></script>
    <script type="text/javascript" src="{{ asset('/') }}tmp_mobile/javascript/init.js"></script>
